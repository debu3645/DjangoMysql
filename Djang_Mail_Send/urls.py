...
from views import PostCreate, cachetbl, cacheget
...
urlpatterns = [
	...
	url(r'^home1/$', views.home1, name='homes1'),
	url(r'^mail/$', views.sendmail, name='mails2'),
	url(r'^mail1/$', views.beforesendmail, name='mails1'),
	url(r'^cache2/$', views.cacheget, name='cache2test')]
