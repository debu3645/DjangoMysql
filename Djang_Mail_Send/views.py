...
#from dajax.core import Dajax  # For Ajax
#from dajaxice.utils import deserialize_form #For Ajax
...
def cachetbl(request):
	...
	entry3= Postxx.objects.get(pk=2)
	...
	return render(request, 'cache1.html',{'form':form,'entry':entry, 'entry2':entry2, 'entry3':entry3}) 
...
def sendmail(request):
	#if request.method== "POST":
	send_mail('Django sending 1st mail', 'HI. This is to see if Django is sending mails or not.', 'vineet4u@yahoo.com', ['vineet4u@yahoo.com'], fail_silently=False)
	return HttpResponse('email sent successfully')
	#return render(request, 'sendmail.html',) 

def beforesendmail(request):
	#if request.method== "POST":
	#	send_mail('Django sending 1st mail', 'HI. This is to see if Django is sending mails or not.', 'vineet4u@yahoo.com', ['debu3645@gmail.com'], fail_silently=False)
	#return HttpResponse('email sent successfully')
	return render(request, 'sendmail.html',) 
...
def cacheget(request):
	...
	return render(request, 'cache2.html',{'form':form,'entry':cache}) 